<div class="space-y-4">
    ...
    <div class="flex items-center justify-between">
        <div>
            <h2 class="text-2xl font-bold text-gray-900">Conversion Report</h2>
            <p class="mt-1 text-sm text-gray-600">Track application conversions by programme, source, and counsellor</p>
        </div>
        ...
        <div class="flex flex-wrap gap-3">
            ...
            <div>
                ...
                <input
                    id="from_date"
                    type="date"
                    wire:model.defer="filters.from_date"
            ...
            <div>
                ...
                <input
                    id="to_date"
                    type="date"
                    wire:model.defer="filters.to_date"
                    class="rounded-md border border-gray-300 bg-white px-3 py-2 text-sm text-gray-900 focus:border-indigo-500 focus:outline-none focus:ring-1 focus:ring-indigo-500"
                />
            </div>
            ...
            <div>
                ...
                <select
                    id="programme_id"
                    wire:model.defer="filters.programme_id"
                    class="rounded-md border border-gray-300 bg-white px-3 py-2 text-sm text-gray-900 focus:border-indigo-500 focus:outline-none focus:ring-1 focus:ring-indigo-500">
            ...
            {{-- Counsellor --}}
            <div>
                <label for="counsellor_id" class="block text-xs font-medium text-gray-700 mb-1">Counsellor</label>
                <select
                    id="counsellor_id"
                    wire:model.defer="filters.counsellor_id"
                    class="rounded-md border border-gray-300 bg-white px-3 py-2 text-sm text-gray-900 focus:border-indigo-500 focus:outline-none focus:ring-1 focus:ring-indigo-500">
            ...
            {{-- Source --}}
            <div>
                <label for="source" class="block text-xs font-medium text-gray-700 mb-1">Source</label>
                <input
                    id="source"
                    type="text"
                    wire:model.defer="filters.source"
                    placeholder="e.g. organic, referral"
        ...
        <table class="w-full">
            <thead class="border-b border-gray-200 bg-gray-50">
                <tr>
                    ...
                    <th class="px-6 py-3 text-left text-xs font-semibold text-gray-700">Conversions</th>
                    ...
                    <tr class="hover:bg-gray-50 transition-colors">
                        ...
                        <td class="px-6 py-4">
                            <p class="text-sm text-gray-600">
                                {{ $row['from_date'] ? \Carbon\Carbon::parse($row['from_date'])->format('M d, Y') : '—' }}
                            </p>
                        </td>
                        <td class="px-6 py-4">
                            <p class="text-sm text-gray-600">
                                {{ $row['to_date'] ? \Carbon\Carbon::parse($row['to_date'])->format('M d, Y') : '—' }}
                            </p>
                        </td>
                    </tr>
                @empty
                    <tr>
                        <td colspan="6" class="px-4 py-16 text-center">
                            ...
                            <p class="text-sm font-medium text-gray-500">No conversion data found</p>
