<x-layouts.crm title="New Academic Year">
    <div class="space-y-6">

        {{-- Page header --}}
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-2xl font-bold text-gray-900">New Academic Year</h1>
                <p class="mt-1 text-sm text-gray-500">Define a new academic year period</p>
            </div>
        ...
        {{-- Form --}}
        <form method="POST" action="{{ route('crm.admin.academic-years.store') }}">
            @csrf
            ...
            <div class="card p-6 space-y-5">
                ...
                <div class="form-group">
                    ...
                    <p class="mt-1 text-xs text-gray-400">Only one academic year can be active at a time. Enabling this will deactivate the current one.</p>
                </div>
