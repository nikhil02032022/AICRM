<x-layouts.crm title="Add Campus">
    <div class="space-y-6">

        {{-- Page header --}}
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-2xl font-bold text-gray-900">Add Campus</h1>
                <p class="mt-1 text-sm text-gray-500">Create a new campus for your institution</p>
            </div>
        ...
        {{-- Form --}}
        <form method="POST" action="{{ route('crm.admin.campuses.store') }}">
            @csrf
            ...
            <div class="card p-6 space-y-5">
                ...
                <div class="grid gap-5 sm:grid-cols-2">
                    ...
                    <div class="form-group">
                        ...
                        >
                        <p class="mt-1 text-xs text-gray-400">Up to 20 characters. Used as a short identifier.</p>
                        @error('code')
                            <p class="mt-1 text-xs text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
                ...
                <div class="flex items-center gap-3 border-t border-gray-100 pt-5">
                    <button type="submit" class="btn-primary">Create Campus</button>
