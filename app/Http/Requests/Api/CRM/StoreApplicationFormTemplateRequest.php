...
// BRD: CRM-AP-001 — Validation for creating configurable multi-step application form templates
class StoreApplicationFormTemplateRequest extends FormRequest
{
    /** @var list<string> */
    ...
    public function rules(): array
    {
        return [
            ...
            'sections.*.fields.*.id' => ['required', 'string', 'max:60'],
            'sections.*.fields.*.type' => ['required', Rule::in(['text', 'textarea', 'email', 'tel', 'number', 'date', 'select', 'checkbox', 'radio', 'file', 'signature'])],
            'sections.*.fields.*.label' => ['required', 'string', 'max:160'],
