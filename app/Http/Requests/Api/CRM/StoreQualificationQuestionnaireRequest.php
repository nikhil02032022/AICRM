...
// BRD: CRM-LQ-009 — Validation for creating qualification questionnaires
final class StoreQualificationQuestionnaireRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'status' => ['nullable', Rule::enum(QuestionnaireStatus::class)],
